...
echo $before
hadoop jar $HADOOP_HOME/share/hadoop/tools/lib/hadoop-streaming-2.9.2.jar -D stream.non.zero.exit.is.failure=false -D mapreducer.job.maps=3 -files /root/examples/avg/CountMapper.class,/root/examples/avg/CountReducer.class -input /user/root/input/mid-foo.txt -output /user/root/output-count -mapper "java CountMapper " -reducer "java CountReducer"
