...
echo $before
hadoop jar $HADOOP_HOME/share/hadoop/tools/lib/hadoop-streaming-2.9.2.jar -D stream.non.zero.exit.is.failure=false  -files /root/examples/std-dev/SumCount.class,/root/examples/std-dev/AvgMapper.class,/root/examples/std-dev/AvgReducer.class -input /user/root/input/mid-foo.txt -output /user/root/output-avg -mapper "java AvgMapper " -reducer "java AvgReducer"
